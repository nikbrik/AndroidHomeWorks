...
class Team(private val teamNumber: Int, private val warriorCount: Int) {
    ...
    fun getWarriorCount(): Int {
        return warriors.filter { !it.isKilled }.count()
    }
    ...
    fun randomAliveWarrior(): AbstractWarrior =
        getAliveWarriors()[Random.nextInt(getAliveWarriorsCount())]
}
